			...
			<div className="w-4/5">
				...
				<div className="flex flex-col md:flex-row justify-around items-center mt-8 space-y-6 md:space-y-0 md:space-x-6">
					{[...Array(4)].map((_, index) => (
						<div
							key={index}
							className="relative w-full md:w-1/5 flex flex-col items-center bg-white shadow-md rounded-sm  hover:shadow-lg transition-shadow duration-300 py-8 px-4  border border-gray-50">
							<div className="relative w-full flex items-center justify-center mb-4  ">
								<Image
									className="object-cover absolute bottom-1"
									src={exprinced}
									height={50}
									width={50}
									alt="image not found"
